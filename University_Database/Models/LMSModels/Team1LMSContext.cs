...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1235883;Password=database;Database=Team1LMS");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Classes>(entity =>
            {
                ...
                entity.Property(e => e.Loc).HasColumnType("varchar(101)");
            ...
            modelBuilder.Entity<Courses>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Num, e.Department })
                    .HasName("Num")
                    .IsUnique();
                ...
                entity.Property(e => e.Num).HasColumnType("char(4)");
            ...
            modelBuilder.Entity<Enrolled>(entity =>
            {
                ...
                entity.Property(e => e.Grade).HasColumnType("varchar(3)");
